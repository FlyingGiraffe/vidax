...
RUN_MATRIX = [
    ...
    ("run_hunyuan_video_1_5.py", ["--resolution", "480p", "--task", "t2v"], "HunyuanVideo-1.5"),
    ("run_hunyuan_video_1_5.py", ["--resolution", "480p", "--task", "i2v"], "HunyuanVideo-1.5"),
    ("run_hunyuan_video_1_5.py", ["--resolution", "720p", "--task", "t2v"], "HunyuanVideo-1.5"),
    ("run_hunyuan_video_1_5.py", ["--resolution", "720p", "--task", "i2v"], "HunyuanVideo-1.5"),
    ("run_hunyuan_video_1_0.py", [], "HunyuanVideo"),
